using static ParallelProgramming.AsynchronousProgramming.Examples.LocalInversionOfControl.ExtensionMethods;

namespace ParallelProgramming.AsynchronousProgramming.Examples.LocalInversionOfControl
{
    ...
    public class LocalInversionOfControl
    {
