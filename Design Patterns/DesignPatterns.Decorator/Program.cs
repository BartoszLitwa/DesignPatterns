...
using DesignPatterns.Decorator.Examples.StaticDecoratorComposition;

CustomStringBuilder.Start(args);

AdapterDecorator.Start(args);
...
StaticDecoratorComposition.Start(args);

DecoratorInDependencyInjection.Start(args);